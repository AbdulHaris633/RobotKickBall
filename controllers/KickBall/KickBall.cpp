// Webots Simulation for making Op2 robot as a soccer player
// It can visually detect and identify the ball and can kick it and shoot towards goal if near goalpost
...
"ShoulderR" /*ID1 */ , "ShoulderL" /*ID2 */ , "ArmUpperR" /*ID3 */ , 
		"ArmUpperL" /*ID4 */ , "ArmLowerR" /*ID5 */ , 
		"ArmLowerL" /*ID6 */ , "PelvYR" /*ID7 */ , "PelvYL" /*ID8 */ , 
		"PelvR" /*ID9 */ , "PelvL" /*ID10 */ , 
		"LegUpperR" /*ID11 */ , "LegUpperL" /*ID12 */ ,
		"LegLowerR" /*ID13 */ , 
		"LegLowerL" /*ID14 */ , "AnkleR" /*ID15 */ , 
		"AnkleL" /*ID16 */ , "FootR" /*ID17 */ , "FootL" /*ID18 */ , 
		"Neck" /*ID19 */ , "Head" /*ID20 */  
		};
...
new RobotisOp2VisionManager (mCamera->getWidth (),
									  mCamera->getHeight (), 
28, 20, 50, 45,
									  0, 30);
...
y = 2.0 * y / height - 1.0; 
		...
		// Shoot towards the goal if the ball is in view and close enough to the goalpost
		double goalpostX = 1.0;	// Example X-coordinate of the goalpost
		double goalpostY = 0.0;	// Example Y-coordinate of the goalpost
		double directionX = goalpostX - x; 
double directionY = goalpostY - y; 
double distanceToGoal = sqrt (directionX * directionX + directionY * directionY); 
 
if (distanceToGoal < 0.75)	// Adjust the threshold as needed
		{
		
		// Call the function to shoot towards the goalpost
		shootTowardsGoal (); 
}
...
cout << "---------------ROBOTIS OP2 Soccer Player---------------"
		<< endl;
		
 
cout <<
		
"This demonstration illustrates most of the possibilities of OP2 Soccer Player"
 ...
 <<endl; 
		...
		mSpeaker->
speak 
		("Hi, my name is ROBOTIS OP2 Soccer Player. I can walk, use my camera to find the ball, and perform complex motion like "
		 
		 
"kicking the ball towrads the goal if near goalpost and getting up If I fall",
...
const double *acc = mAccelerometer->getValues (); 
		...
		// count steps on the accelerometer
...
clamp (-x, minMotorPositions[18], maxMotorPositions[18]);
		
 
headPosition =
		
clamp (-y, minMotorPositions[19], maxMotorPositions[19]); 
...
py = 0.0; 
		...
		// search by turning round and moving head vertically
		else
...
clamp (0.7 * sin (2.0 * getTime ()), minMotorPositions[19],
				
maxMotorPositions[19]);
